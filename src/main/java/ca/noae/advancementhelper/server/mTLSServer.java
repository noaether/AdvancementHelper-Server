...
public class mTLSServer {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            try (InputStream sKInputStream = classloader.getResourceAsStream(KEYSTORE_LOCATION)) {
            ...
            try (InputStream sTInputStream = classloader.getResourceAsStream(TRUSTSTORE_LOCATION)) {
